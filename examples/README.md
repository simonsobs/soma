...
| [`scattering_des.ipynb`](scattering_des.ipynb) | `soma.scattering` at $L = 2048$: download the DES footprint, simulate a lognormal field in it, and time the scattering covariances with the numpy backend or the JAX backend (chosen in the first cell). |
